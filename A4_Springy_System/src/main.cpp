...
// DEMO = 1 Euler vs. RK4
// DEMO = 2 Collision with sphere
// DEMO = 3 Collision with faces
// DEMO = 4 Edge to Edge collision
...
static void init()
{
	...
	prog->addUniform("texture_cloth_1");
...
void render()
{
	...
	// Draw the face for collision tests
	if (DEMO == 3) {
		glBegin(GL_TRIANGLES);
		glColor3d(0.5f, 1.0f, 1.0f);
		glVertex3f(0.5f, 0.5f, 0.0);
		glVertex3f(0.0, 0.0f, -0.5);
		glVertex3f(0.0, 0.0f, 0.5);
		glEnd();
	}
